    ...
    <>
      ...
      <main id="main-content" className="flex-grow">
        <HeroSection
          ...
          year="2026"
          taglineStart="Ihre"
          tagwords={["SICHTBARKEIT.", "TALENTE.", "REICHWEITE."]}
          showScrollIndicator={true}
          scrollToId="tickets-heading"
        />

        <section className="py-16 md:py-24 bg-surface text-white" aria-labelledby="tickets-heading">

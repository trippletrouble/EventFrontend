...
const Footer: React.FC = () => {
  return (
      <footer
          className="bg-[#0b0c10] border-t border-surface-overlay text-foreground-muted py-16"
      ...
      >
        <div className="max-w-[1320px] mx-auto px-6 lg:px-12 grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="flex flex-col gap-6 font-semibold text-white">
            <Link href="/imprint" className="hover:text-brand-yellow transition-colors focus-ring rounded self-start">
              Impressum
            </Link>
            <Link href="/privacy" className="hover:text-brand-yellow transition-colors focus-ring rounded self-start">
              Datenschutz
            </Link>
          </div>
          ...
          <div className="flex flex-col text-sm text-foreground-muted md:pt-9 pt-0">
            <div className="flex flex-col gap-1">
              <div>
                E-Mail:{" "}
                <a
                    href="mailto:info@events.hof-university.de"
                    className="underline hover:text-brand-yellow transition-colors focus-ring rounded"
                >

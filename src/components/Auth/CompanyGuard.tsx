...
export function CompanyGuard({ children }: CompanyGuardProps) {
  ...
  if (isLoading) {
    return (
      <main id="main-content" tabIndex={-1} className="flex justify-center items-center min-h-[50vh] pt-28" aria-label="Zugriff wird geprüft">
  ...
  if (!isAuthenticated) {
    return (
      <main id="main-content" tabIndex={-1} className="flex flex-col justify-center items-center min-h-[50vh] pt-28 gap-4" aria-label="Zugriff verweigert">
